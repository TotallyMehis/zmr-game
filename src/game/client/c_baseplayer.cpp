...
#ifdef ZMR // ZMRCHANGE: Duck time causes predictions errors and makes the view laggy.
	DEFINE_PRED_FIELD_TOL( m_flDucktime, FIELD_FLOAT, FTYPEDESC_INSENDTABLE, 1.0f ),
#else
...
//-----------------------------------------------------------------------------
C_BaseViewModel *C_BasePlayer::GetViewModel( int index_ /*= 0*/, bool bObserverOK ) const
{
