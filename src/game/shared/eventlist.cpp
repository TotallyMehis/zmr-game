...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT( AE_CL_REMOVE_PARTICLE_EFFECT, AE_TYPE_CLIENT );

	REGISTER_SHARED_ANIMEVENT( AE_TAUNT_ADD_ATTRIBUTE, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_SV_EXCLUDE_PLAYER_SOUND, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_CL_EXCLUDE_PLAYER_SOUND, AE_TYPE_CLIENT );
